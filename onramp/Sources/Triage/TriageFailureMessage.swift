...
enum TriageFailureMessage {
    static let generic = """
        ...
        or use the Playbooks tab (Can’t get online) without the model.
        """
    ...
    static func from(_ error: Error) -> String {
        ...
        return """
            ...
            and try again, or use the Playbooks tab.
            """
    }
    ...
    private static func mapGenerationError(_ error: Error) -> String? {
        ...
        case .unsupportedLanguageOrLocale:
            return """
                ...
                English, or use the Playbooks tab.
                """
        default:
