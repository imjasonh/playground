...
final class TriageInstructionsTests: XCTestCase {
    func testInstructionsCoverProposeOnly() {
        ...
        XCTAssertTrue(text.localizedCaseInsensitiveContains("Onramp"))
    ...
    func testInstructionsPrioritizeNetwork() {
        let text = TriageInstructions.text
        XCTAssertTrue(text.localizedCaseInsensitiveContains("path_status"))
        XCTAssertTrue(text.localizedCaseInsensitiveContains("dns_config"))
        XCTAssertTrue(text.localizedCaseInsensitiveContains("captive"))
        ...
        XCTAssertTrue(text.localizedCaseInsensitiveContains("back online"))
    }
...
final class TriageFailureMessageTests: XCTestCase {
    func testOpaqueGenerationErrorCopyIsActionable() {
        ...
        XCTAssertTrue(message.localizedCaseInsensitiveContains("Playbooks"))
    }
