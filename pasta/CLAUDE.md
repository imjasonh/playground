...
Pasta now lives inside the [playground](https://github.com/imjasonh/playground)
monorepo as `pasta/`. Repo-wide agent rules in `/AGENTS.md` apply;
playground Cloud Agent / PR workflow conventions supersede any
standalone-repo commit gate that used to live here.
