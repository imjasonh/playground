...
| New App ID **capability / entitlement** on an existing id (Push, HealthKit, NFC, App Attest, …) | **Yes** — update App ID + refresh profile |
...
and App Attest on the host when missing (needed for the App Attest experiment).
