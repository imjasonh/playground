...
def build_placed_board() -> tuple[pcbnew.BOARD, list[pcbnew.SHAPE_POLY_SET]]:
    ...
    qi_present_start = board_point(4.3, 64.75)
    qi_present_end = board_point(10.85, 86.2)
    add_locked_track(
        pad_center("U2", "7"),
        qi_present_start,
        "/QI_PRESENT",
    ...
    add_locked_via(qi_present_start, "/QI_PRESENT")
    add_locked_path(
        (
            (4.3, 64.75),
            (4.3, 81.5),
    ...
    add_locked_via(qi_present_end, "/QI_PRESENT")
    add_locked_track(
        qi_present_end,
        pad_center("U1", "11"),
        "/QI_PRESENT",
    ...
    qi_en2_start = board_point(9.2, 63.35)
    qi_en2_end = board_point(13.5, 89.4)
    add_locked_track(
        pad_center("U2", "11"),
        qi_en2_start,
        "/QI_EN2",
    ...
    add_locked_via(qi_en2_start, "/QI_EN2")
    add_locked_path(
        (
            (9.2, 63.35),
            (11.5, 65.65),
    ...
    add_locked_via(qi_en2_end, "/QI_EN2")
    add_locked_track(
        qi_en2_end,
        pad_center("U1", "25"),
        "/QI_EN2",
    ...
    charger_int_start = board_point(54.2, 60.4)
    charger_int_end = board_point(16.5, 87.4)
    add_locked_track(
        pad_center("U3", "9"),
        charger_int_start,
        "/CHG_INT_N",
    ...
    add_locked_via(charger_int_start, "/CHG_INT_N")
    add_locked_path(
        (
            (54.2, 60.4),
            (57.0, 63.2),
    ...
    add_locked_via(charger_int_end, "/CHG_INT_N")
    add_locked_track(
        charger_int_end,
        pad_center("U1", "20"),
        "/CHG_INT_N",
