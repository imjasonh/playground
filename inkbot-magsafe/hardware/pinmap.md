...
| Charge enable | P0.06 | 22 | out | CHG_EN_N | active low; 100 kOhm default-enable pull-down |
| Battery/SYS sense | SAADC VDDHDIV5 | internal | analog in | SYS | no external divider; valid in high-voltage mode |
...
| VDD | VDD | 28 | regulated out | VDD_NRF | decoupling and high-impedance SWD reference only |
| VDDH | VDDH | 30 | pwr in | SYS | BQ25185 power-path output |
...
Do not pull them up to `SYS`, which can reach 4.5 V. P0.03 remains unassigned.
