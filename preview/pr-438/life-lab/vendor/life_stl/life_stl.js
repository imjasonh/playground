...
export class SimResult {
    ...
    get base() {
        try {
            ...
            wasm.simresult_base(retptr, this.__wbg_ptr);
     ...
     */
    get brace_count() {
        const ret = wasm.simresult_brace_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    get braces() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.simresult_braces(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     */
    get interesting() {
        const ret = wasm.simresult_interesting(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    get life_voxels() {
        const ret = wasm.simresult_life_voxels(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get one_piece() {
        const ret = wasm.simresult_one_piece(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get period() {
        const ret = wasm.simresult_period(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    get quiescent_generation() {
        const ret = wasm.simresult_quiescent_generation(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get required_active() {
        const ret = wasm.simresult_required_active(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    get voxels() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.simresult_voxels(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU32FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export3(r0, r1 * 4, 4);
 ...
 * @param {number} height
 * @param {number} depth
 * @param {number} cell_mm
 * @param {string} name
 * @returns {Uint8Array}
 */
export function export_3mf(cells, width, height, depth, cell_mm, name) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(cells, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.export_3mf(retptr, ptr0, len0, width, height, depth, cell_mm, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
 ...
 * @returns {Uint8Array}
 */
export function export_stl(cells, width, height, depth, cell_mm) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(cells, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.export_stl(retptr, ptr0, len0, width, height, depth, cell_mm);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {Uint8Array}
 */
export function pattern_cells(name, width, height, seed, density) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.pattern_cells(retptr, ptr0, len0, width, height, seed, density);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {SimResult}
 */
export function simulate(cells, width, height, depth) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(cells, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.simulate(retptr, ptr0, len0, width, height, depth);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('life_stl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
