...
├── mapvelopes/            # Rust Cloudflare Worker: #10 envelopes with a route map
...
| `mapvelopes/` | #10 envelope PDFs with the sender-to-recipient route as the background (requires a Google Maps key) | `cargo test` + clippy + wasm build |
