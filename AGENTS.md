...
├── population-rays/       # directional corridor population map (JS + Node tests)
...
| `population-rays/` | Directional corridor population (“people along a line”) over Meta/CIESIN HRSL grids | Node test runner |
