...
| Directory | Type | Tests |
|-----------|------|-------|
| `ios/` | The single "Playground" SwiftUI app — a launcher hosting experiments (e.g. Ride Monitor, T9 Keyboard, Mega Man 2 Widget); TestFlight CD on `main` | XCTest unit tests + XCUITest UI tests (`fastlane test`) |
