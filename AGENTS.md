...
├── tank-commander/        # Rust CLI: Tank Commander Skirmish balance/fun simulator
...
| `tank-commander/` | no | Rust CLI (Skirmish balance/fun simulator); no `index.html` |
...
| `tank-commander/` | Monte Carlo Skirmish simulator for [Tank Commander](https://github.com/imjasonh/tank-commander) (drama + stalemate metrics) | `cargo test` + clippy |
