...
| `inkbot-magsafe/` | Rust/nRF52833 firmware and EVT hardware for the 4-inch BLE e-paper tile. Host logic and design contracts are tested; peripheral bring-up remains incomplete. Design: [`docs/inkbot-magsafe-design.md`](docs/inkbot-magsafe-design.md). Agent guide: [`inkbot-magsafe/AGENTS.md`](inkbot-magsafe/AGENTS.md) | host logic tests, `thumbv7em-none-eabihf` cross-build, schematic contracts, and PCB DRC via `inkbot-magsafe.yml` |
