...
export const DISPLAYS = [
  ...
  {
    id: "waveshare-4in2-mono",
    name: "Waveshare 4.2\" (mono)",
    category: "Monochrome (Carta)",
    inches: 4.2,
    width: 400,
    height: 300,
    ...
    palette: "gray4",
    response: "carta",
    refresh: "~4 s full refresh, 0.3 s partial",
    note: "Hobbyist SPI panel, 4-level grayscale, 400x300.",
  },
  {
    id: "good-display-3in7-mono",
    name: "Good Display 3.7\" (mono)",
    category: "Monochrome (Carta)",
    inches: 3.7,
    width: 416,
    height: 240,
    ...
    palette: "gray4",
    response: "carta",
    refresh: "~2 s full refresh, 1.5 s fast, 0.3 s partial",
    note: "GDEY037T03 fast-update SPI panel, 4-level grayscale, 416x240.",
  },
  {
    id: "good-display-4in26-mono",
    name: "Good Display 4.26\" (mono)",
    category: "Monochrome (Carta)",
    inches: 4.26,
    width: 800,
    height: 480,
    ...
    palette: "gray4",
    response: "carta",
    refresh: "~3.5 s full refresh, 1.5 s fast, 0.42 s partial",
    note: "GDEY0426T82 fast-update SPI panel, 4-level grayscale, 800x480.",
  },
  {
    id: "good-display-0in97-mono",
    name: "Good Display 0.97\" (mono)",
    category: "Monochrome (Carta)",
    inches: 0.97,
    width: 184,
    height: 88,
    ...
    palette: "gray4",
    response: "carta",
    refresh: "~2 s full or 4-gray refresh, 0.3 s partial",
    note: "GDEM0097T61 18-pin SPI panel, 4-level grayscale, 184x88.",
  },
  {
  ...
  {
    id: "good-display-0in97-bwry",
    name: "Good Display 0.97\" (B/W/R/Y)",
    category: "ESL (3 & 4 color)",
    inches: 0.97,
    width: 184,
    height: 88,
    ...
    palette: "bwry",
    response: "esl",
    refresh: "~16 s full refresh, 12 s fast",
    note: "GDEM0097F51 18-pin SPI panel with black, white, red, and yellow inks.",
  },
];
