...
* No auth. (OAuth + JWT bearer tokens, IAM with branch-scoped tokens, and
  declarative push-time policy checks are proposed in
  [`docs/auth-and-push-policy.md`](docs/auth-and-push-policy.md).)
